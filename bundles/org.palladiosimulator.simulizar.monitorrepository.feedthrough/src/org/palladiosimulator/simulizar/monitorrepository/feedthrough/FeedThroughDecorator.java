...
public class FeedThroughDecorator extends AbstractRecordingProbeFrameworkListenerDecorator {
	...
	private void initFeedThroughMeasurements(final MeasurementSpecification measurementSpecification) {
        ...
        var expectedMetric = GET_BASE_METRIC_SWITCH
    ...
    private static final MetricSpecSwitch<Optional<BaseMetricDescription>> GET_BASE_METRIC_SWITCH = new MetricSpecSwitch<Optional<BaseMetricDescription>>() {
        
        public java.util.Optional<BaseMetricDescription> caseBaseMetricDescription(BaseMetricDescription object) {
            return Optional.of(object);
        }


        @Override
        public Optional<BaseMetricDescription> defaultCase(final EObject eObject) {
            return Optional.empty();
        }
    };
    
    
    private static void checkValidity(final Optional<BaseMetricDescription> expectedMetric,
