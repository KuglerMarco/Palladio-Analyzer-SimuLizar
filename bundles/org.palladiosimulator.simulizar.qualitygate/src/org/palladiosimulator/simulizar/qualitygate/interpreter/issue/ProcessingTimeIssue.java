...
/**
 * Records the Issues of ProcessingTime Qualitygates
 * 
 * @author Marco Kugler
 *
 */
public class ProcessingTimeIssue implements QualitygateIssue {
    ...
    public ProcessingTimeIssue(Entity stereotypedObject, QualityGate qualitygate, boolean isHandled) {
        super();
